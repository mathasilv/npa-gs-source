...
class Colors:
    """
    Classe de compatibilidade para acesso às cores do tema.

    Permite usar Colors.BG_PRIMARY em vez de THEME_COLORS['background'].
    """
    # Backgrounds
    BG_PRIMARY = THEME_COLORS["background"]
    BG_SECONDARY = THEME_COLORS["surface_secondary"]
    BG_TERTIARY = THEME_COLORS["surface_tertiary"]

    # Text
    TEXT_PRIMARY = THEME_COLORS["text"]
    TEXT_SECONDARY = THEME_COLORS["text_dim"]
    TEXT_MUTED = THEME_COLORS["text_dim"]
    ...
    BORDER_ACCENT = THEME_COLORS["border"]
...
/* Listas internas do QComboBox (dropdown) - estilo checkbox */
...
/* QListView geral - estilo checkbox */
QListView {{
    background-color: {THEME_COLORS['background']};
    border: 1px solid {THEME_COLORS['accent']};
    border-radius: 4px;
...
/* Checkboxes em QListView (usado em CheckableComboBox) */
QListView::indicator {{
    width: 14px; height: 14px;
    background-color: {THEME_COLORS['background']};
    border: 1px solid {THEME_COLORS['border_subtle']};
...
QListView::indicator:hover {{ border: 1px solid {THEME_COLORS['text_dim']}; }}
...
QTreeWidget::indicator:indeterminate {{
    background-color: {THEME_COLORS['accent']}80;
    border: 1px solid {THEME_COLORS['accent']};
}}
